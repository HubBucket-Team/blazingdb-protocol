...
from blazingdb.messages.blazingdb.protocol.interpreter import gdf_column
...
class gdf_column(transport.schema(gdf_column)):
...
class GetResultResponseSchema(transport.schema(GetResultResponse)):
  ...
  values = transport.VectorSegment(gdf_column)
