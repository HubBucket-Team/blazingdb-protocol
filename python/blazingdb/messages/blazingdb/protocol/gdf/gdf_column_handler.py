...
def gdf_column_handlerAddCustringsViews(builder, custringsViews): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(custringsViews), 0)
def gdf_column_handlerAddSize(builder, size): builder.PrependUint64Slot(3, size, 0)
def gdf_column_handlerAddDtype(builder, dtype): builder.PrependInt8Slot(4, dtype, 0)
def gdf_column_handlerAddDtypeInfo(builder, dtypeInfo): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(dtypeInfo), 0)
def gdf_column_handlerAddNullCount(builder, nullCount): builder.PrependUint64Slot(6, nullCount, 0)
